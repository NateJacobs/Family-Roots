	...
	<div class="page-content">
		<div class="media">
			<span class="pull-left" href="#">
				...
				<?php else: ?>
					<img class="media-object img-rounded" src="<?php echo family_roots_get_person_photo($person); ?>" alt="<?php echo $person->get('first_name').' '.$person->get('last_name'); ?>" width="200" height="200">
				<?php endif; ?>
			</span>
		...
		<?php foreach($person->get_media() as $media): ?>
			...
			<div class="col-xs-6 col-md-3">
				<div class="thumbnail">
					<img src="<?php echo family_roots_get_photo_url($media->thumb_path); ?>" alt="<?php echo $person->get('first_name').' '.$person->get('last_name'); ?>">
				</div>
